...
const Navbar = () => {
  ...
  return (
    <div className="border-b shadow-lg  bg-transparent">
      <header className=" wrapper flex  items-center  justify-between !py-1   text-rose-500  font-bold ">
            ...
            >
              ...
              {item.item1 && (
                <div className="absolute top-12 -left-10 bg-white  flex-col gap-6 py-3 px-3   shadow-2xl rounded-lg flex w-48 text-sm uppercase  ">
                  ...
                  <a className="hover:underline">{t("yonetim")}</a>
